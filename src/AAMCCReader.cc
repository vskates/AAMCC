...
void AAMCCReader::ReadFirstStage(AAMCCrun* runData, InitialConditions* InCond){
  ...
  else
  {
    ...
    while(!NucleusInputLabel){
      std::cout << "Please enter colliding nucleus name (side A). U, U2, Bi, Bipn, Pb, Pbrw, Pbpn, Pbpnrw, Au, Aurw, W, Au2, Au2rw, Xe, Xe124, Xe130, Ag, Br, Cu, Ca2 (with SRC), Ar, Al, O, O2 (with SRC), Oho (for HO param.), C, He4, He3, H3, d, p is available : ";
    ...
    while(!NucleusInputLabel){
      std::cout << "Please enter colliding nucleus name (side B). U, U2, Bi, Bipn, Pb, Pbrw, Pbpn, Pbpnrw, Au, Aurw, W, Au2, Au2rw, Xe,  Xe124, Xe130, Ag, Br, Cu, Ca2 (with SRC), Ar, Al, O, O2 (with SRC), Oho (for HO param.), C, He4, He3, H3, d, p is available : ";
...
void AAMCCReader::ReadSecondStage(AAMCCrun* runData, InitialConditions* InCond){
  ...
  while(runData->DeExModel.empty()){
      std::cout<<"Choose a model for fragment deexcitation. G4 and AAMCC options are available: ";
